...
export function SettingsPage() {
  ...
  const FIELDS = {
    ...
    marketing: [{ key: 'announcement_text', label: 'Announcement Bar Text', type: 'text' }, { key: 'newsletter_title', label: 'Newsletter Title', type: 'text' }, { key: 'newsletter_subtitle', label: 'Newsletter Subtitle', type: 'text' }, { key: 'footer_copyright', label: 'Footer Copyright', type: 'text' }, { key: 'app_android_url', label: 'Android App URL', type: 'text' }, { key: 'app_ios_url', label: 'iOS App URL', type: 'text' }],
